...
set "LOG=%APPDIR%\master_app_launch.log"
...
if not "%MASTER_APP_HOT_RELOAD%"=="" set DEV_HOT_RELOAD=%MASTER_APP_HOT_RELOAD%
if not "%MASTER_APP_HOT_INTERVAL%"=="" set HOT_RELOAD_INTERVAL=%MASTER_APP_HOT_INTERVAL%
if not "%MASTER_APP_HOT_DEBOUNCE%"=="" set HOT_RELOAD_DEBOUNCE=%MASTER_APP_HOT_DEBOUNCE%
if not "%MASTER_APP_HOT_MIN_UPTIME%"=="" set HOT_RELOAD_MIN_UPTIME=%MASTER_APP_HOT_MIN_UPTIME%
if not "%MASTER_APP_HOT_DECISION_TIMEOUT%"=="" set HOT_RELOAD_DECISION_TIMEOUT=%MASTER_APP_HOT_DECISION_TIMEOUT%
